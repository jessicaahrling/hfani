'use strict';
const W=1080,H=1920,SCX=540,SCY=760;
...
function finish(){
  ...
  if(MASK>0){const g=V.createLinearGradient(0,1230,0,1540);g.addColorStop(0,'rgba(0,0,0,0)');g.addColorStop(1,`rgba(0,0,0,${.9*MASK})`);V.fillStyle=g;V.fillRect(0,1230,W,H-1230);
    const g2=V.createLinearGradient(0,0,0,150);g2.addColorStop(0,`rgba(0,0,0,${.7*MASK})`);g2.addColorStop(1,'rgba(0,0,0,0)');V.fillStyle=g2;V.fillRect(0,0,W,150);}
}
